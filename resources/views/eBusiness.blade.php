    ...
    <div class="hero-container">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item" style="background-image: url({{URL::asset('assets
            /img/hero-carousel/2.jpg')}})">
                    <div class="carousel-container">
                        <div class="container">
...
<main id="main">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="well-left">
                        <div class="single-well">
                            <a href="#">
                                <img src="{{URL::asset('assets/img/about/1.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="reviews-area">
        <div class="row g-0">
            <div class="col-lg-6">
                <img src="{{URL::asset('assets/img/about/2.jpg')}}" alt="" class="img-fluid">
            </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-blog">
                            <div class="single-blog-img">
                                <a href="blog.html">
                                    <img src="{{URL::asset('assets/img/blog/1.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="blog-meta">
                  ...
                  <a href="blog.html" class="ready-btn">Read more</a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-blog">
                            <div class="single-blog-img">
                                <a href="blog.html">
                                    <img src="{{URL::asset('assets/img/blog/2.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="blog-meta">
                  <span class="comments-type">
                  ...
                  <a href="blog.html" class="ready-btn">Read more</a>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="single-blog">
                            <div class="single-blog-img">
                                <a href="blog.html">
                                    <img src="{{URL::asset('assets/img/blog/3.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="blog-meta">
                  <span class="comments-type">
